  ...
  writedata(0x1D); ///writedata(0x23);      //N=0x36 for 6.5M, 0x23 for 10M crystal
  writedata(0x02);
  writedata(0x54);
  ...
  writedata(0x01);
  writedata(0xDD);///writedata(0x1F);
  writedata(0xDE);///writedata(0xFF);

  writecommand(0xB0);   //LCD SPECIFICATION
  writedata(0x2C);///writedata(0x20);
  writedata(0x00);
  writedata(0x01);    //Set HDP 479 //319
  writedata(0x3F);///writedata(0xDF);
  writedata(0x00);///writedata(0x01);    //Set VDP 271  //239
  writedata(0xEF);///writedata(0x01);
  writedata(0x00);///writedata(0x0F);

  writecommand(0xB4);   //HSYNC
  writedata(0x01);///writedata(0x02);    //Set HT  531
  writedata(0x98);///writedata(0x13);
  writedata(0x00);    //Set HPS 8
  writedata(0x44);///writedata(0x08);
  writedata(0x14);///writedata(0x2B);    //Set HPW 43
  ...
  writedata(0x06);///writedata(0x20);
  writedata(0x00);    //Set VPS 4
  writedata(0x12);///writedata(0x04);
  writedata(0x04);///writedata(0x0c);    //Set VPW 12
  ...
  writedata(0);
  writedata(0);
  writedata(0x01);///writedata((239 & 0xFF00)>>8);///271
  writedata(0x3f);///writedata(239 & 0xFF);

  writecommand(0x2B); 
  writedata(0);
  writedata(0);
  writedata(0x00);///writedata((319 & 0xFF00)>>8);///479
  writedata(0xEF);///writedata(319 & 0xFF);
